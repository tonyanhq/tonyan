...
//			
//			jQuery("div.slide").animate({opacity: "hide", height: "hide"}, "slow");
//			
...
//
		...
		jQuery(document).ready(function(){
		    ...
		    var newHash      = "",
		        jQuerymainContent = jQuery("#"),
		        jQuerypageWrap    = jQuery("#"),
		        baseHeight   = 0,
		        jQueryel;
		    ...
		    jQuery('#header ul li a').click(function() {
		        	...
		        	if(jQuery(this).hasClass("blog")||jQuery(this).hasClass("screenshots")){
		    ...
		    jQuery(window).bind('hashchange', function(){
		        ...
		        if (newHash) {
		            ...
		            jQuery("."+thisClass).animate({opacity: "show", height: "show"}, "slow");
		           	jQuery('#header ul li.active').removeClass("active");
		            jQuery("."+thisClass).parent("li").addClass("active");
		            return false;
